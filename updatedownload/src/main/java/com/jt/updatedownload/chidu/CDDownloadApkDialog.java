package com.jt.updatedownload.chidu;
 ...
 * 软件下载更新弹框
 */
public class CDDownloadApkDialog extends BaseDialog {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1002:
                    ...
                    if (CDDownloadApkDialog.this != null) {
                        CDDownloadApkDialog.this.dismiss();
                    }
                    try {
    ...
    public CDDownloadApkDialog(@NonNull Context context, GetNewBean bean, String authority) {
        super(context);
